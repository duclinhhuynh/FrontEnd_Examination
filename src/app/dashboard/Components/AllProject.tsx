        ...
        <div className="p-2 ">
            ...
            <div>
                <table className="min-w-full bg-[#0D0F10] rounded-lg ">
                    <thead>
                        <tr className="bg-[#0D0F10] text-[#667085]">
                    ...
                    <tbody>
                        <tr className="bg-gray-800 border-b border-gray-700">
                            <td className="py-3 px-4 flex items-center">
                                ...
                                <div>
                                    <div className="text-[#667085]">Sisyphus</div>
                                    <div className="text-sm text-gray-400">sisyphus.com</div>
                                </div>
                            </td>
                            <td className="py-3 px-4 text-[#667085]">22 Jan 2022</td>
                            ...
                            <td className="py-3 px-4 flex justify-end">
                                <button className="text-gray-400 hover:text-gray-200 mr-3"><FaTrash /></button>
                                <button className="text-gray-400 hover:text-gray-200"><MdEdit /></button>
                            </td>
                        </tr>
